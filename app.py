...
#model = load_model('Nikky 1\OneDrive\Documents\StockPriceProj\StockPredictionsModelkeras.zip')
model = keras.models.load_model('Nikky 1\OneDrive\Documents\StockPriceProj\StockPredictionsModelkeras.zip')
